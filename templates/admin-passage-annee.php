...
<select id="<?php echo esc_attr($field_id); ?>" name="classe_<?php echo esc_attr($row['child_id']); ?>">
...
<?php submit_button('Confirmer le passage d\'année', 'primary', 'submit', false); ?>
</p>
</form>
...
<?php submit_button('Annuler', 'secondary', 'submit', false); ?>
</form>
</div>
<?php endif; ?>
</div>
