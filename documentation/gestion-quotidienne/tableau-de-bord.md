...
Connectez-vous à WordPress avec un rôle autorisé à gérer le périscolaire. Les chiffres et les alertes sont calculés à partir des données présentes dans le plugin ; actualisez la page après une opération importante.
...
5. Vérifiez la **Commande fournisseur — semaine du …** dans **Commande fournisseur**, puis envoyez-la lorsqu'elle est prête.
6. Si l'année scolaire est absente ou proche de sa fin, ouvrez **Année scolaire** pour définir les dates, vacances et jours fériés ou préparer l'année suivante.
   ...
   ![Bloc « À faire » du tableau de bord avec les liens vers les demandes, le menu, la commande fournisseur et l'année scolaire](../assets/screenshots/dashboard-a-faire.png)
