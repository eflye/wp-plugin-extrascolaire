...
2. Renseignez **Libellé**, **Date de début** et **Date de fin**. La date de fin doit être postérieure à la date de début, puis cliquez sur **Créer l'année**.
...
5. Pour corriger une année existante, modifiez son **Libellé**, sa **Date de début** ou sa **Date de fin** directement dans **Années existantes**, puis cliquez sur **Enregistrer**.
